togglebutton = Widget.extend({
  ...
  addClickListener : function() {
	...
	var tmpdevhwid = this.device.getHWID();
  ...
  onClick : function(device_hwid,reading) {
	var state=null;
	var tmpread = reading;
	var initialhwvalue;
	...
	if (state != "") {
		...
		// not possible as device_hwid is the one for FHEM and not the unique one required for the document
		// work-around: use short update intervals
/*		if (initialhwvalue != "") {
			$("#"+device_hwid +"_value").html( initialhwvalue );
		}*/
	}
  },
